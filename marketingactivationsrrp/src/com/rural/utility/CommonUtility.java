...
public static String convertListToString(ArrayList list) {
	...
	public static Map<String,String> getAssetMap()
	{
		...
		assetMap.put("DB","DB");
		assetMap.put("DWP","DWP");
		assetMap.put("WP","WP");
		return assetMap;
	}
	/*public static Map<String,List<Integer>> getAssetSizeMap()
	{
		Map<String,List<Integer>> assetSizeMap=new HashMap<String, List<Integer>>();
		List<Integer> sizeList=new ArrayList<Integer>();
		sizeList.add(18);
		assetSizeMap.put("DB",sizeList);
		
		return assetSizeMap;
	}
*/
	public static Map<String, String> getNoGoFilterMap() {
		Map<String,String> noGoFilterMap=new HashMap<String, String>();
		noGoFilterMap.put("6", "6 months");
		noGoFilterMap.put("12", "12 months");
		return noGoFilterMap;
	}
