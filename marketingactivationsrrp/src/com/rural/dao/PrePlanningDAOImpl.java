...
public class PrePlanningDAOImpl implements PrePlanningDAO{
	...
	public List<ConversionMaster> getConversionData(String strBrand) {
		logger.debug("======START PrePlanningDAOImpl getConversionData======");
		...
		while(itr.hasNext()) {
			...
			logger.error("Exception occured while loading getConversionData :"+ he.getMessage());
			throw new ERPException("Exception occured while loading getConversionData :"+ he.getMessage());
		} catch (ERPException erp) {
			logger.error("Exception occured while loading getConversionData :"+ erp.getMessage());
			throw new ERPException("Error while loading getConversionData");
		} catch (Exception e) {
			logger.error("Exception occured while loading getConversionData :"+ e.getMessage());
			throw new ERPException("Error while loading getConversionData");
		} finally {
			session.close();
		}
		logger.debug("======END PrePlanningDAOImpl getConversionData======");
