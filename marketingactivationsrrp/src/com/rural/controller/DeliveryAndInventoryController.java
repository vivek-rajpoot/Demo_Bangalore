...
public class DeliveryAndInventoryController {
	...
	public String  viewInventory(@RequestParam("req_Num") String strReq_Num,HttpServletRequest request, HttpServletResponse response,ModelMap model){
		String statusMsg=null;
		try {
...
public @ResponseBody void getDate(
		@RequestParam("reqNo") String reqNo, HttpServletRequest req,
		Model model) {
	try {
	...
	public @ResponseBody List<String> getCity(
			@RequestParam("city") String strCity, HttpServletRequest req,
			Model model) {
	...
	public  String createDeliveryAndInventory(
			...
			@RequestParam("remarks") String strRemarks,HttpServletRequest req,
			Model model) {
