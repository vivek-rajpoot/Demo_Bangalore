...
public class PrePlanningController {
	...
	public @ResponseBody List<String> getState(@RequestParam("brand") String strBrand, HttpServletRequest req, Model model,HttpServletRequest request) {
	...
	public ModelAndView createPrePlanMaster(HttpServletRequest request, ModelAndView modelAndView) {
